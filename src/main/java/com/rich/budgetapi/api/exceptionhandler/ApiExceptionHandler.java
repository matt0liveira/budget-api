...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
        ...
        if (ex instanceof MethodArgumentTypeMismatchException) {
            return handleMethodArgumentTypeMismatch((MethodArgumentTypeMismatchException) ex, request, headers, status);
        }
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,
        ...
        List<ProblemApi.Object> problemsObj = bindingResult
                ...
                .stream()
                .map(objProblem -> {
                    String msg = messageSource.getMessage(objProblem, LocaleContextHolder.getLocale());
