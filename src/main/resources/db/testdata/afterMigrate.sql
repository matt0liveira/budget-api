...
insert into permission (id, name, description) values (1, 'CHANGE_USERS_GROUPS_PERMISSIONS', 'Allows creation, changing and deleting of users');
...
insert into permission (id, name, description) values (4, 'CONSULT_USERS_GROUPS_PERMISSIONS', 'Allows to consult users');
...
insert into `group` (id, name) values (1, 'Gerente'), (2, 'Vendedor'), (3, 'Secretário'), (4, 'Cadastrador');