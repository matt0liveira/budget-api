...
insert into transaction (code, user_id, type_transaction, category_id, description, date) values ('24faa01b-c97b-47a6-be67-b054bfe78d55', 1, 'EXPENSE', 1, 'Compra do mês', utc_timestamp);